...
class V3FeatureRuntime:
    ...
    def extract_handcrafted(self, text: str):
        import numpy as np
        from model_router.features import extract_handcrafted

        return extract_handcrafted(text).astype(np.float32)

    def extract_tfidf(self, text: str):
        import numpy as np
    ...
    def extract_context(self, metadata: dict):
        from model_router.features import ContextMetadata, extract_context_features
    ...
    def extract_hist(self, prev_route_decisions: list):
        from model_router.features import extract_hist_features
...
class InferenceArtifacts:
    ...
    def load_runtime_objects(self, config: dict, *, use_aux_head: bool) -> dict[str, object]:
        ...
        from model_router.v4_features import BGEChannelExtractor
