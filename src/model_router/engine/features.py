"""Feature vector builder — 390-dimensional combined feature vector."""

from __future__ import annotations

from model_router.engine.types import FeatureBundle, InferenceRequest
from model_router.v4_features import (
