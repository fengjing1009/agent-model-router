...
from model_router.flags import RoutingFlags, compute_flags
...
class SquillaRouter:
    ...
    def __new__(cls, model_dir: str = "models/", *args, **kwargs):
        ...
        if version_path.exists():
            try:
                ...
                ver = None
            if ver == "v4":
                from model_router.v4_predictor import V4Router
    ...
    def __init__(self, model_dir: str = "models/",
        ...
        from model_router.features import FeatureExtractor
    ...
    def predict(self, text: str, context: ContextMetadata | None = None, *,
        ...
        from model_router.trajectory import classify as classify_trajectory
