"""Data classes for the inference engine."""

from __future__ import annotations

from dataclasses import dataclass, field

# numpy is only used for type hints (string-quoted under PEP 563)
# Actual numpy import happens where the types are instantiated
